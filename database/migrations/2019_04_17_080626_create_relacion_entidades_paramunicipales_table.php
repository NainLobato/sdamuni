...
class CreateRelacionEntidadesParamunicipalesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('relacion_entidades_paramunicipales', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('relacion_entidades_paramunicipales');
    }
}
