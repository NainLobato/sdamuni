...
class CreateJuiciosPromovidosPorAyuntamientosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('juicios_promovidos_por_ayuntamientos', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('juicios_promovidos_por_ayuntamientos');
    }
}
