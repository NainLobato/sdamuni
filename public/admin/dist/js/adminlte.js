! function(e, t) {
    ...
    "use strict";
    var t, n, i, o, r, a, s, c, f, l, u, d, h, p, _, g, y, m, v, C, D, E, A, O, w, b, L, S, j, T, I, Q, R, P, x, B, M, k, H, N, Y, U, V, G, W, X, z, F, q, J, K, Z, $, ee, te, ne = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
            return typeof e
        } : function(e) {
        ...
        oe = (t = jQuery, n = "ControlSidebar", i = "lte.control.sidebar", o = t.fn[n], r = ".control-sidebar", a = '[data-widget="control-sidebar"]', s = ".main-header", c = "control-sidebar-open", f = "control-sidebar-slide-open", l = {
            slide: !0
        }, u = function() {
            function e(t, n) {
                ie(this, e), this._element = t, this._config = this._getConfig(n)
            }
            return e.prototype.show = function() {
                this._config.slide ? t("body").removeClass(f) : t("body").removeClass(c)
            }, e.prototype.collapse = function() {
                this._config.slide ? t("body").addClass(f) : t("body").addClass(c)
            }, e.prototype.toggle = function() {
                this._setMargin(), t("body").hasClass(c) || t("body").hasClass(f) ? this.show() : this.collapse()
            }, e.prototype._getConfig = function(e) {
                return t.extend({}, l, e)
            }, e.prototype._setMargin = function() {
                t(r).css({
                    top: t(s).outerHeight()
                })
                ...
                return this.each(function() {
                    var o = t(this).data(i);
                    if (o || (o = new e(this, t(this).data()), t(this).data(i, o)), "undefined" === o[n]) throw new Error(n + " is not a function");
                    o[n]()
                })
            }, e
        }(), t(document).on("click", a, function(e) {
            e.preventDefault(), u._jQueryInterface.call(t(this), "toggle")
        }), t.fn[n] = u._jQueryInterface, t.fn[n].Constructor = u, t.fn[n].noConflict = function() {
            return t.fn[n] = o, u._jQueryInterface
        }, u),
        re = (d = jQuery, h = "Layout", p = "lte.layout", _ = d.fn[h], g = ".main-sidebar", y = ".main-header", m = ".content-wrapper", v = ".main-footer", C = "hold-transition", D = function() {
            function e(t) {
                ie(this, e), this._element = t, this._init()
            }
            return e.prototype.fixLayoutHeight = function() {
                var e = {
                ...
                return this.each(function() {
                    var n = d(this).data(p);
                    n || (n = new e(this), d(this).data(p, n)), t && n[t]()
                })
            }, e
        ...
        ae = (E = jQuery, A = "PushMenu", w = "." + (O = "lte.pushmenu"), b = E.fn[A], L = {
            ...
            function e(t, n) {
                ie(this, e), this._element = t, this._options = E.extend({}, S, n), E(j.OVERLAY).length || this._addOverlay()
            }
            return e.prototype.show = function() {
                E(j.BODY).addClass(T).removeClass(T);
                ...
                return this.each(function() {
                    var n = E(this).data(O);
                    n || (n = new e(this), E(this).data(O, n)), t && n[t]()
                })
            }, e
        ...
        se = (R = jQuery, P = "Treeview", B = "." + (x = "lte.treeview"), M = R.fn[P], k = {
            ...
            function e(t, n) {
                ie(this, e), this._config = n, this._element = t
            }
            return e.prototype.init = function() {
                ...
                var e = this;
                R(document).on("click", this._config.trigger, function(t) {
                    e.toggle(t)
                })
            }, e._jQueryInterface = function(t) {
                return this.each(function() {
                    var n = R(this).data(x),
                        i = R.extend({}, G, R(this).data());
                    n || (n = new e(R(this), i), R(this).data(x, n)), "init" === t && n[t]()
                })
            }, e
        ...
        ce = (X = jQuery, z = "Widget", q = "." + (F = "lte.widget"), J = X.fn[z], K = {
            ...
            function e(t, n) {
                ie(this, e), this._element = t, this._parent = t.parents(Z.CARD).first(), this._settings = X.extend({}, ee, n)
            }
            return e.prototype.collapse = function() {
                var e = this;
                ...
                return this.each(function() {
                    var n = X(this).data(F);
                    n || (n = new e(X(this), n), X(this).data(F, "string" == typeof t ? n : t)), "string" == typeof t && t.match(/remove|toggle/) ? n[t]() : "object" === ("undefined" == typeof t ? "undefined" : ne(t)) && n._init(X(this))
                })
            }, e
