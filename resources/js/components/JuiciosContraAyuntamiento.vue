...
<div>
    <b-card
        ...
        <span>Administrador de juicios en proceso promovidos en contra del ayuntamiento</span>
        </template>
    </b-card>
    <div class="row">
        <div class="col-md-4">
            ...
            >
                <b-card-body align="left">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="demandante">Nombre de la persona que inicio el proceso:</label>
                                <input type="text" id="demandante" name="demandante" class="form-control" placeholder="Ingrese nombre" data-vv-as="nombre" v-validate="'required|max:200'">
                                <div class="invalid-feedback" v-if="errors.has('demandante')">{{ errors.first('demandante') }}</div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
