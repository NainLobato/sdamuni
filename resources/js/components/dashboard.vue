        ...
        data(){
            return{
                cards:[
                    ...
                    {imagen: window.location.protocol+ '//' + window.location.host+'/'+'admin/dist/img/icons8-page-96.png', href: route('acuerdo-pendiente.index').template,color:'background-color:#0abab5;',titulo:'Libros de actas',descripcion:'Crea, elimina, edita acuerdos'},
