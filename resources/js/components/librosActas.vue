                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" id="clave" name="clave" class="form-control" placeholder="Ingrese clave" data-vv-as="clave" v-validate="'required'">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" id="fecha_primer_sesion" name="fecha_primer_sesion" class="form-control" data-vv-as="fecha de primer sesion" v-validate="'required'">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" id="fecha_ultima_sesion" name="fecha_ultima_sesion" class="form-control" data-vv-as="fecha de ultima sesion" v-validate="'required'">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="primer_folio" name="primer_folio" class="form-control" placeholder="Ingrese folio de la primer acta" data-vv-as="primer folio" v-validate="'required|numeric'">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="ultimo_folio" name="ultimo_folio" class="form-control" placeholder="Ingrese folio de la ultima acta" data-vv-as="ultimo folio" v-validate="'required|numeric'">
                        ...
                        <div class="col-md-7">
                            <div class="form-group">
                                ...
                                <textarea  rows="3" id="comentarios" name="comentarios" class="form-control" placeholder="Ingrese comentarios" data-vv-as="comentarios" v-validate="'alpha_dash_field'"></textarea>
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <input type="text" id="ubicacion" name="ubicacion" class="form-control" placeholder="Ingrese ubicacion de comentarios" data-vv-as="ubicacion" v-validate="'alpha_dash_field'">
